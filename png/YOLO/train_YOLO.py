...
x_DIR =  os.path.join(parent,r'data_sample\wsirois\roi-level-annotations\tissue-cells\images')
y_DIR =  os.path.join(parent,r'data_sample\wsirois\roi-level-annotations\tissue-cells\tiger-coco.json')
